...
![Updated](https://img.shields.io/badge/updated-2026--08--15-brightgreen?style=flat-square)&nbsp;![Records](https://img.shields.io/badge/records-26.8M-blue?style=flat-square)&nbsp;[![Rebrowser](https://img.shields.io/badge/full%20dataset-rebrowser.net-orange?style=flat-square)](https://rebrowser.net/products/datasets/gametime)
...
> **213,324** total records from 2025-11-16 to 2026-08-09, **up to 30,000** rows in this sample (14.1% of full dataset).
> Exported as one file per day, up to 1,000 rows each, last 30 days retained.
...
| `trendingScore` 🔒 | `float` | 96% | Event trending score |
...
> **10,829** total records from 2025-11-16 to 2026-08-09, **1,000** rows in this sample (9.2% of full dataset).
...
> **4,849** total records from 2025-11-16 to 2026-08-09, **1,000** rows in this sample (20.6% of full dataset).
> Exported as a single file, overwritten daily.
...
[Instant Delivery Listings](https://rebrowser.net/products/datasets/gametime/event-listings/views/listings-instant-delivery) — 72,064 records
...
[Cheapest Deal Listings](https://rebrowser.net/products/datasets/gametime/event-listings/views/listings-cheapest-deal) — 1,004,764 records
...
[NBA Events](https://rebrowser.net/products/datasets/gametime/events/views/nba-events) — 1,489 records

↳ `[{"field":"category","op":"is","value":"nba"},{"sort":"datetimeUtc ASC"}]`

[Music & Concert Events](https://rebrowser.net/products/datasets/gametime/events/views/gametime-music-events) — 76,159 records
